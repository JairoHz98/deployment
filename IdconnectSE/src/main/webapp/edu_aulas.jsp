                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="card shadow-sm mb-4">
                                        <div class="card-header bg-white text-center">
                                            <h4 class="text-dark"><i class="bi bi-person-plus"></i> Registro de Aulas</h4>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="create">
                                                ...
                                                <div style="display: none;" class="mb-3">
                                                    <label for="id_aula" class="form-label">ID del Aula:</label>
                                                    <input type="text" class="form-control" id="id_aula" name="id_aula" >
                                                </div>
                                                ...
                                                <!-- Botón de envío -->
                                                <div class="d-grid">
                                                    <button type="submit" name="g" value="register_aula" class="btn btn-success">Registrar Aula</button>
                                                </div>
                                            </form>
