                                ...
                                <div class="row justify-content-center">
                                        ...
                                        <div class="card shadow-sm">
                                            <div class="card-header bg-white text-white text-center">
                                                <h4 class="text-dark"><i class="bi bi-calendar-check-fill"></i> Horario Institucional</h4>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="create" class="row g-3 mt-2">
                                                    <div class="container-fluid col-12">
                                                         <!-- Jornada -->
                                                <div class="mb-3">
                                                    <label for="jornada" class="form-label">Selecciona jornada:</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label><input name="d1" type="checkbox" value="1" id="check-lunes"> Lunes</label>
                                                    <label><input name="d2" type="checkbox" value="1" id="check-martes"> Martes</label>
                                                    <label><input name="d3" type="checkbox" value="1" id="check-miércoles"> Miércoles</label>
                                                    <label><input name="d4"  type="checkbox" value="1" id="check-jueves"> Jueves</label>
                                                    <label><input name="d5" type="checkbox" value="1" id="check-viernes"> Viernes</label>
                                                </div>
                                                ...
                                                <!-- Botón para aplicar horario -->
                                                <div class="mb-3 text-center">
                                                    <button class="btn btn-success" name="g" value="createworkday">Aplicar horario</button>
                                                </div>
                                                    </div>
                                        ...
                                        <div class="card shadow-sm mt-4">
                                            <div class="card-header bg-white text-white text-center">
                                                <h4 class="text-dark"><i class="bi bi-calendar-check-fill"></i> Resumen </h4>
                                            </div>

                                            <div class="container-fluid">
                                                <!-- Campos generados -->
                                                <div class="row g-3 mt-2" id="campos-horarios"></div>
                                            </div>
