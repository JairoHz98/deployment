...
<%@page import="com.idconnect.model.e3uesmaterias"%>
<%@page import="com.idconnect.model.e3uesmaula"%>
...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Configuraciòn de Materias</title>
                                    ...
                                    <div class="">
                                        <div class="card shadow-sm">
                                            <div class="card-header bg-white text-white text-center">
                                                <h4 class="text-dark"><i class="bi bi-calendar-check-fill"></i> Configuración de Materias</h4>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="create" class="row g-3 mt-2">
                                                        ...
                                                        <!-- Docente -->
                                                        <div class="mb-3">
                                                            <label for="aula" class="form-label">Seleccionar Docente:</label>
                                                            <select id="aula" name="iddocente" class="form-select">
                                                               <option value="">-- Selecciona --</option>
                                                                <%list li = new list();
                                                                for (e3uesm l : li.get_listtecacher()) {
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="aula" name="idaula" class="form-select">
                                                                <option value="">-- Selecciona --</option>
                                                                <%for (e3uesmaula l : li.get_listaulas()) {%>
                                                                <option value="<%=l.getId_aula()%>"><%=l.getNombre()%></option>
                                                            ...
                                                            <!-- Matwria -->
                                                        <div class="mb-3">
                                                            <label for="aula" class="form-label">Selecciona Materias:</label>
                                                                <select id="aula" name="idmaterias" class="form-select">
                                                                <option value="">-- Selecciona --</option>
                                                                <%for (e3uesmaterias l : li.get_listmaterias()) {%>
                                                                <option value="<%=l.getId_materia()%>"><%=l.getNombre()%></option>
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="time" name="entrada" class="form-control" id="hora-inicio-base">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Hora de Salida</label>
                                                        <input type="time" name="salida" class="form-control" id="hora-fin-base">
                                                    </div>
                                                </div>
                                                        
                                                         <!-- Número de materias -->
                                                        <div  style="display: none;"class="mb-3">
                                                            <label for="numMaterias" class="form-label">¿Cuántas materias se impartirán hoy?</label>
                                                            <input type="number" id="numMaterias" class="form-control" min="1" max="10" placeholder="Ej. 3">
                                                        </div>

                                                        <!-- Contenedor dinámico -->
                                                        <div style="display: none;" id="materiasContainer" class="row g-4"></div>

                                                        <!-- Botones -->
                                                        <div class="mt-4 text-center">
                                                            <button style="display: none;" class="btn btn-success" onclick="generarMaterias()">Generar materias</button>
                                                            <button class="btn btn-primary ms-2" name="g" value="register_issue">Guardar horarios</button>
