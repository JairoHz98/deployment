                            ...
                            <div class="row g-4 mt-3">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="card shadow-sm mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="create" id="ftable" class="row g-3 mt-2" method="post">
                                                <div class="col-md-6">
                                                    <div class="row align-items-start">

                                                        <div class="col-8">
                                                            <input type="text" class="form-control" id="code" name="code" placeholder="Ingresar Huella o Tarjeta" disabled>

                                                        </div>
                                                        <div class="col d-grid gap-1">
                                                            <button type="button" id="bcode" name="bcode" class="btn btn-success mb-3">Escanear</button>
                                                    ...
                                                    <script>
                                                        ...
                                                        const button = document.getElementById('bcode');

                                                        // Al hacer clic en el botón, habilita el input
                                                        button.addEventListener('click', () => {
                                                            input.disabled = false;
                                                            input.focus();
                                                        });

                                                        // Cuando se escribe algo en el input, cambia el texto del botón
                                                        input.addEventListener('input', () => {
                                                            if (input.value.trim() !== '') {
                                                                button.textContent = 'Escaneado';
                                                                input.disabled = false;
                                                            } else {
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="uid" name="uid" class="form-control" placeholder="Generar UID unico">
                                                </div>



                                                <div class="col-md-6">
                                                    <input type="text" id="n" name="n" class="form-control" placeholder="Nombre completo" oninput="document.getElementById('name').value = this.value">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" id="cedula" name="cedula" class="form-control" placeholder="Cédula o ID" oninput="document.getElementById('cards').value = this.value">
                                                </div>
                                                <div class="col-md-6">
                                                    <select id="rol" name="rol" class="form-select" oninput="document.getElementById('rols').value = this.value">
...
%>  
<input style="display: none;"  id="datehistory" name="datehistory" value="<%=fecha%> <%=hora%>"/>
                                                    <input style="display: none;" id="iduser" name="iduser" value="<%= ((e3uesm) session.getAttribute("e3uesm")).getId() %>" />
                                                    <input style="display: none;" name="mensajeRegistro" type="text" id="mensajeRegistro" readonly> 
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    const input = document.getElementById("mensajeRegistro");

    function actualizarMensaje() {
      const textoRol = select.options[select.selectedIndex].text;
      input.value = "Registro nuevo " + textoRol;
    }
    ...
    select.addEventListener("change", actualizarMensaje);
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="g" value="register">
                                            ...
                                            <form id="cardForm">
                                                <div style="display: none;">
                                                    <input type="text" id="cardInput" autocomplete="off" oninput="document.getElementById('code').placeholder = this.value" />
                                                    <input type="text" id="name" />
                                                    <input type="type" id="uidcopy" name="uidCOPY" />
                                                    <input type="type"  id="cards"name="cards" />
                                                    <input type="type" id="rols" name="rols"/>
                                                    <input type="type" name="fechan"/>
                                            ...
                                            <div class="card-body mb-4">
                                                ...
                                                <thead>
                                                    ...
                                                    <tbody>
                                                        <%
           list ls = new list();
           for (e3uesmhistory l : ls.get_list_history()) {
   %> 
                                                        <tr>
                                                            <td><%= l.getDatehystory()%></td>
                                                            <td><%= l.getNameComplete()%></td>
                                                            <td><%= l.getDetail()%></td>
                                                        </tr>
                                                        <%}  %>
                                                    </tbody>
